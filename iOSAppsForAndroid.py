...
class iOSAppsForAndroid(loader.Module):
	...
	strings = {
		...
		"apps-list": "<i><b>The list of applications in the module at the moment:\n| iCall | iLauncher | iLock |\n| iSwiftKeyboard | iWhatsApp |\n| iNotes | iMessages | iContacts |\n| iPhotos | iCalculator | iVoice |\n|iCompas |\n| All applications are taken from the channel @progi95 | @IbreymMods |</b></i>",
		...
		"icompas1": "<b>iCompass Pro is an iOS—style compass for android, with a beautiful iPhone design that will help you quickly and easily determine the exact direction and position on the map.\n🔑Mods: PRO version.</b>",
	...
	strings_ru = {
		"_cls_doc": "iOS приложения на Android, или же проще говоря Android приложения с интерфейсом, как на iOS",
		"apps-list": "<i><b>Список приложений в модуле на данный момент: \n| iCall | iLauncher | iLock |\n| iSwiftKeyboard | iWhatsApp |\n| iNotes | iMessages | iContacts |\n| iPhotos | iCalculator | iVoice |\n|iCompas |\n| Все приложения взяты из каналов @progi95 | @IbreymMods |</b></i>",
		...
		"icompas1": "<b>🔥iCompass Pro — это компасс в стиле ios на android, с красивым айфоновским дизайном, которые поможет вам быстро и легко определить точное направление и положение на карте.\n🔑Моды: PRO версия.</b>",
	...
	async def icall(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iCall_text"),file="https://t.me/progi95/3806")

	async def ilauncher(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iLauncher_text1"),file="https://0x0.st/o1Pe.jpg")
		await self.client.send_message(self.chat_id,self.strings("iLauncher_text2"),file="https://t.me/progi95/3801")

	async def ilock(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iLock_text"),file="https://t.me/progi95/3796")

	async def iswift(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iSwiftKey_text1"),file="https://0x0.st/o1ZH.jpg")
		await self.client.send_message(self.chat_id,self.strings("iSwiftKey_text2"),file="https://t.me/progi95/3754")

	async def iwhatsapp(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iWhatsApp_text1"),file="https://0x0.st/o1Zm.jpg")
		await self.client.send_message(self.chat_id,self.strings("iWhatsApp_text2"),file="https://t.me/progi95/3897")
		await self.client.send_message(self.chat_id,self.strings("iWhatsApp_text3"),file="https://t.me/progi95/3898")

	async def inotes(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iNotes_text"),file="https://t.me/IbreymMods/576")

	async def iphotos(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iPhotos_text"),file="https://t.me/IbreymMods/574")

	async def icontacts(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iContacts_text"),file="https://t.me/IbreymMods/573")

	async def imessages(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iMessages_text"),file="https://t.me/IbreymMods/572")

	async def icalculator(self, *_):
		await self.client.send_message(self.chat_id,self.strings("iCalculator_text"),file="https://t.me/IbreymMods/577")

	async def icompas(self, *_):
		await self.client.send_message(self.chat_id,self.strings("icompas1"),file="https://0x0.st/oeEW.jpg")
		await self.client.send_message(self.chat_id,self.strings("icompas2"),file="https://t.me/progi95/3885")
