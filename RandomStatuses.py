...
class RandomStatusMod(loader.Module):
    ...
    async def rstatuscmd(self, message: Message):
        ...
        await self.inline.form(
            text="Привет! Если ты за статусом, то нажми кнопку ниже, чтобы получить рандомный статус!",
            reply_markup=[
    ...
    async def random_status(self, call: InlineCall):
        ...
        if rand1 == "list":
            statuses = [
                ...
                "Счастье — это когда ты нашёл человека, который искал тебя", "Преодолевая трудности, мы приобретаем мудрость",
                ...
                "Человек без воли что нож без стали", "Когда ваши дела идут плохо — не ходите за ними",
                ...
                "Утром когда восходит солнце позвольте ему взойти и в вас тоже", "Твой дом там, где спокойны твои мысли",
                ...
                "Если не хочешь, чтобы враг раскрыл твою тайну, то не открывай её даже другу",
